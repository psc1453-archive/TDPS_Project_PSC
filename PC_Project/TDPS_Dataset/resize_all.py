...
resolution_dir = '/run/media/psc/LinuxData/Carset/FullFrame/' + aim_resolution
...
call_resize_args = [['/run/media/psc/LinuxData/Carset/FullFrame/1080p/'] * files_num,
                      ['/run/media/psc/LinuxData/Carset/FullFrame/' + aim_resolution + '/'] * files_num, files_list]
