...
#define AI_NETWORK_MODEL_SIGNATURE     "b4a0cdf80f7df895c1418d66e968a7fd"
...
#define AI_TOOLS_DATE_TIME   "Sun Jun 13 02:23:43 2021"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 60976, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &input_image_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &predicted_value_output),
