...
#define DISTANCE_RIGHT_ECHO_Pin GPIO_PIN_1
#define DISTANCE_RIGHT_ECHO_GPIO_Port GPIOB
#define DISTANCE_RIGHT_ECHO_EXTI_IRQn EXTI1_IRQn
#define DISTANCE_RIGHT_TRIG_Pin GPIO_PIN_2
#define DISTANCE_RIGHT_TRIG_GPIO_Port GPIOB
...
#define DISTANCE_LEFT_ECHO_Pin GPIO_PIN_10
#define DISTANCE_LEFT_ECHO_GPIO_Port GPIOD
#define DISTANCE_LEFT_ECHO_EXTI_IRQn EXTI15_10_IRQn
#define DISTANCE_LEFT_TRIG_Pin GPIO_PIN_11
#define DISTANCE_LEFT_TRIG_GPIO_Port GPIOD
#define DISTANCE_FRONT_ECHO_Pin GPIO_PIN_8
#define DISTANCE_FRONT_ECHO_GPIO_Port GPIOC
#define DISTANCE_FRONT_ECHO_EXTI_IRQn EXTI9_5_IRQn
#define DISTANCE_FRONT_TRIG_Pin GPIO_PIN_9
#define DISTANCE_FRONT_TRIG_GPIO_Port GPIOC
