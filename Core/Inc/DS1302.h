...
typedef struct
{
    GPIO_TypeDef* DS1302_SCL_Port; uint16_t DS1302_SCL_Pin;
    GPIO_TypeDef* DS1302_SDA_Port; uint16_t DS1302_SDA_Pin;
    GPIO_TypeDef* DS1302_CE_Port;  uint16_t DS1302_CE_Pin;
}DS1302;
