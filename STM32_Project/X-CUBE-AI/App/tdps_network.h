...
#ifndef AI_TDPS_NETWORK_H
#define AI_TDPS_NETWORK_H
#pragma once

#include "tdps_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_TDPS_NETWORK_MODEL_NAME          "tdps_network"
#define AI_TDPS_NETWORK_ORIGIN_MODEL_NAME   "final_sim"

/******************************************************************************/
#define AI_TDPS_NETWORK_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_TDPS_NETWORK_IN_NUM        (1)
#define AI_TDPS_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 54, 72, 1, 1, NULL), \
}
#define AI_TDPS_NETWORK_IN_SIZE { \
  AI_TDPS_NETWORK_IN_1_SIZE, \
}
#define AI_TDPS_NETWORK_IN_SIZE_BYTES { \
  AI_TDPS_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_TDPS_NETWORK_IN_1_HEIGHT      (54)
#define AI_TDPS_NETWORK_IN_1_WIDTH       (72)
#define AI_TDPS_NETWORK_IN_1_CHANNEL     (1)
#define AI_TDPS_NETWORK_IN_1_SIZE        (54 * 72 * 1)
#define AI_TDPS_NETWORK_IN_1_SIZE_BYTES  (AI_TDPS_NETWORK_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_TDPS_NETWORK_OUT_NUM       (1)
#define AI_TDPS_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 7, 1, NULL), \
}
#define AI_TDPS_NETWORK_OUT_SIZE { \
  AI_TDPS_NETWORK_OUT_1_SIZE, \
}
#define AI_TDPS_NETWORK_OUT_SIZE_BYTES { \
  AI_TDPS_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_TDPS_NETWORK_OUT_1_HEIGHT      (1)
#define AI_TDPS_NETWORK_OUT_1_WIDTH       (1)
#define AI_TDPS_NETWORK_OUT_1_CHANNEL     (7)
#define AI_TDPS_NETWORK_OUT_1_SIZE        (1 * 1 * 7)
#define AI_TDPS_NETWORK_OUT_1_SIZE_BYTES  (AI_TDPS_NETWORK_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_TDPS_NETWORK_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup tdps_network
 ...
 * @ref ai_tdps_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_tdps_network_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_TDPS_NETWORK_*
 * defines into file @ref tdps_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tdps_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TDPS_NETWORK_H */
